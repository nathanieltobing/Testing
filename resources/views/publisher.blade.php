            ...
            <nav class="navbar navbar-expand-lg">
              ...
              <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-OERcA2EqjJCMA+/3y+gxIOqMEjwtxJY7qPCqsdltbNJuaOe923+mo//f6V8Qbsw3" crossorigin="anonymous"></script>
                ...
                <div class="row d-flex justify-content-center mb-4">
                  ...
                  <div class="card mx-2 mt-4 text-center" style="width: 30rem;">
                      <img src="{{url($publisher->image)}}" class="card-img-top" alt="..." style="height:500px">
                      <div class="card-body">
                        <h5 class="card-title">{{$publisher->name}}</h5>
                        <h5 class="card-text">Address:</h5>
                        <h6>{{$publisher->address}}</h6>
                        <div class="row">
                          <a href="/publisher/{{$publisher->id}}" class="btn btn-primary btn-lg">Detail</a>
