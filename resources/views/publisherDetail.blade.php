            ...
            <nav class="navbar navbar-expand-lg">
              ...
              <div class="container d-flex justify-content-center flex-column">
                <div class="d-flex justify-content-center my-4 ">
                  <h1>{{$publisherID->name}}</h1>
                </div>
                
                  <h4 class="card-text d-flex justify-content-center">Address: {{$publisherID->address}}</h5>
          
                  <h4 class="card-text d-flex justify-content-center">Phone: {{$publisherID->phone}}</h5>
                  
                  <h4 class="card-text d-flex justify-content-center">E-mail: {{$publisherID->email}}</h5>
                  
                
          
                <div class="d-flex justify-content-center mt-4 mb-4">
                  @foreach ($publisherID->books as $book)
                  <div class="card mx-2 text-center" style="width: 30rem;">
                      <img src="{{url($book->image)}}" class="card-img-top" alt="..." style="height:500px">
                      <div class="card-body">
                        <h5 class="card-title">{{$book->title}}</h5>
                        <h5 class="card-text">By {{$book->author}}</h5>
                        <div class="row">
                          <a href="/bookDetail/{{$book->id}}" class="btn btn-primary btn-lg">Detail</a>
